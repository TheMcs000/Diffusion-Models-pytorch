...
class EMA:
    ...
    https://youtu.be/TBCRlnwJtZU?t=1156
    Smoothes the trajectory of the model update, thus makes the model more robust.
    Not so sensitive to outliers.

    Copies the initial model weights; updates based on the moving average of the main model
    w = ß • w_old + (1 — ß) • W_new
    """
